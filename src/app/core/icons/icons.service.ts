...
export class IconsService
{
    ...
    constructor()
    {
        ...
        matIconRegistry.addSvgIconSetInNamespace('fa_brand', domSanitizer.bypassSecurityTrustResourceUrl('assets/icons/fontawesome-brands.svg'));
        matIconRegistry.addSvgIconSetInNamespace('fa_regular', domSanitizer.bypassSecurityTrustResourceUrl('assets/icons/fontawesome-regular.svg'));
        matIconRegistry.addSvgIconSetInNamespace('fa_solid', domSanitizer.bypassSecurityTrustResourceUrl('assets/icons/fontawesome-solid.svg'));
        matIconRegistry.addSvgIconSetInNamespace('mdi', domSanitizer.bypassSecurityTrustResourceUrl('assets/icons/mdi.svg'));
    }
}
